// Bookmarklet
//javascript:!function(){void 0==window.getSearchableTable?(arr=new Uint8Array(5),window.crypto.getRandomValues(arr),s=document.createElement("script"),s.src="//rame0.ru/playground/src.js?"+Array.from(arr).join(""),document.head.appendChild(s)):window.getSearchableTable()}();
